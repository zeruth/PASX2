        ...
        public void run() {
            ...
            switch (mOp) {
                case CHR_READ:
                    ...
                    if (ActivityCompat.checkSelfPermission(Main.Companion.getInstance().getApplicationContext(), Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
